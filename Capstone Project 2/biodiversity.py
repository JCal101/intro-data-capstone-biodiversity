...
#Unique count is 5541 (of a total 5824 entries)
...
print(c_status)
#Unique values in the conservation_status column are 'Species of Concern', 'Endangered', 'Threatened', 'In Recovery', 'nan'
...
category_pivot['percent_protected'] = round(((category_pivot.protected / (category_pivot.protected + category_pivot.not_protected)) * 100), 2)
print(category_pivot)
